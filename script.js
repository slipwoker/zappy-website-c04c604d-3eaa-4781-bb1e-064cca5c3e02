document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('minlength')) {
        ...
        if (value.length < min) {
          showFieldError(field, 'Must be at least ' + min + ' characters.');
          isValid = false;
          return;
        }
      }
      ...
      if (field.hasAttribute('maxlength')) {
        ...
        if (value.length > max) {
          showFieldError(field, 'Must be no more than ' + max + ' characters.');
          isValid = false;
          return;
        }
      }
  ...
  function getRequiredMessage(name) {
    const friendly = name.replace(/[-_]/g, ' ').replace(/\b\w/g, function (c) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "נחשקת משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'c04c604d-3eaa-4781-bb1e-064cca5c3e02',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'c04c604d-3eaa-4781-bb1e-064cca5c3e02';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c04c604d-3eaa-4781-bb1e-064cca5c3e02';
